...
class MineSweeper:
    ...
    def click(self, clicked_button: MyButton):
        ...
        if clicked_button.is_mine:
            ...
            showinfo('','Тебе нужно больше тренироваться')
    ...
    def create_settings_window(self):
        ...
        save_btb = tk.Button(win_settings, text='Применить', command=lambda :self.change_settings(row_entry,column_entry,mines_entry))
        save_btb.grid(row=3, column=0, columnspan=2, padx=20,pady=20)
